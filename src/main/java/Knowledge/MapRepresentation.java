...
public class MapRepresentation implements Serializable {
	...
	public static String defaultNodeStyle= "node {"+"fill-color: black;"+" size-mode:fit;text-alignment:under; text-size:14;text-color:white;text-background-mode:rounded-box;text-background-color:black;}";
	public static String nodeStyle_open = "node.agent {"+"fill-color: forestgreen;"+"}";
	public static String nodeStyle_agent = "node.open {"+"fill-color: blue;"+"}";
	public static String nodeStyle=defaultNodeStyle+nodeStyle_agent+nodeStyle_open;

	public transient Graph g; //data structure non serializable
	public transient Viewer viewer; //ref to the display,  non serializable
	...
	public void addNode(String id,MapAttribute mapAttribute){
		Node n;
		//System.out.println("Ajout du noeud : "+id);
